...
// Mostly taken from snow project: https://github.com/underscorediscovery/snow/blob/bfaba3feaaaa88056d7315112b3f1346453c9f81/project/hook.post.js
...
tools.ios_combine_archs = function(flow, done) {
    ...
    if (flow.flags.archs) {
        ...
        var dest = '../ndll/iPhone/libhaxebridge.ios.a';
        ...
        var input_list = [
            '../ndll/iPhone/libhaxebridge.iphonesim.a',      //sim i386
            '../ndll/iPhone/libhaxebridge.iphonesim-64.a',   //sim x86_64
            '../ndll/iPhone/libhaxebridge.iphoneos-v7.a',    //armv7
            '../ndll/iPhone/libhaxebridge.iphoneos-v7s.a',   //armv7s
            '../ndll/iPhone/libhaxebridge.iphoneos-64.a',    //arm64
        ];

        args = args.concat(input_list);

        tools.exec(flow, 'xcrun', args, { quiet:false }, function(code,out,err){
            flow.log(2, 'haxebridge post build - done');
            if (done) done(code);
        });
